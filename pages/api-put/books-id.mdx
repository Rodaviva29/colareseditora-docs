...
The "id" and "_id" values cannot be replaced.
...
### Body (raw)
A json object containing the information that will replace the existing book.
It cannot contain "id" nor "_id" values.
