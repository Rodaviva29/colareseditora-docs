...
### Description
This endpoint allows developers to insert new books to the database by passing a list of book objects in the body.
Each book must be a book object with a unique numeric id field.
