...
The cart object must contain the fields "total", for the total price in the cart, "volume", for the number of books in the cart, and "books", a list of books in the cart, each book is a book object with id.
...
- `books`: List of the books in the cart. Each index is a book object containing its id.
