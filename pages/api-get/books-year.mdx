...
<Tabs items={['HTTP', 'Curl', 'NodeJS', 'Python']} defaultIndex="1">
  <Tabs.Tab>
  ```http copy
    localhost:3001/api/v1/books/year/2012?page=1&limit=10
  ```
  </Tabs.Tab>
  <Tabs.Tab>
  ```curl copy
    curl -X GET 'localhost:3001/api/v1/books/year/2012?page=1&limit=10'
  ```
  </Tabs.Tab>
  ...
  <Tabs.Tab>
    ...
    axios.get('localhost:3001/api/v1/books/year/2012', {
    params: {
        page: 1,
        limit: 10
    }
  ...
  <Tabs.Tab>
    ...
    url = 'localhost:3001/api/v1/books/year/2012'
    params = {
        'page': 1,
        'limit': 10
    }
