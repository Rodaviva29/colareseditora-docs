...
<Tabs items={['HTTP', 'Curl', 'NodeJS', 'Python']} defaultIndex="1">
  <Tabs.Tab>
  ```http copy
    localhost:3001/api/v1/books/price?min_price=50&max_price=60&page=2&limit=20&sort_order=1
  ```
  </Tabs.Tab>
  <Tabs.Tab>
  ```curl copy
    curl -X GET 'localhost:3001/api/v1/books/price?min_price=50&max_price=60&page=1&limit=20&sort_order=1'
  ```
  </Tabs.Tab>
  ...
  <Tabs.Tab>
    ...
    axios.get('localhost:3001/api/v1/books/price', {
    params: {
        min_price: 50,
        max_price: 60,
        page: 1,
  ...
  <Tabs.Tab>
    ...
    url = 'localhost:3001/api/v1/books/price'
    params = {
        'min_price': 50,
        'max_price': 60,
        'page': 1,
