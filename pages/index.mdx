...
This project was mainly inspired by our College course and can be used to inspire more students in their learning process to! We used several programming languages (Python and JavaScript) and also a bit of HTML and CSS.
